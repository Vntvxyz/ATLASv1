	...
	while tasks:
		...
		try:
			with open("key.txt"):
				...
				open("install.sh")
				print("[X] Tất cả các tệp được quét đã hoàn thành!")
		except IOError:
			exit("[X] Some files does not exist, Please install again!")


def getproxy() -> None:
#	print("[+] Kiểm tra nhà cung cấp proxy...")
	print("[+] Vui lòng chờ...")
	with open("proxy_providers.txt", mode="r") as readurl:
#		print("[+] Đang tải xuống proxy...")
		for url in readurl:
			url = url.strip()
			with open("proxy.txt", mode="a") as file:
				try:
					...
					exit()
		print("[+] Tấn công gửi thành công!!")
		print("[+] Nhập 'STOP' để dừng Cuộc tấn công của bạn.")
...
def unavail():
	print("""
╔════════════════════════════════════════════════════════════════════════╗
║            XIN LỖI PHƯƠNG PHÁP BẠN ĐANG THỬ KHÔNG CÓ                   ║           
╚════════════════════════════════════════════════════════════════════════╝
    """)
...
def menu():
	...
	print("""
╔════════════════════════════════════════════════════════════╗
║    [1] USER INFO \033[1;32;40m[Xem thông tin người dùng, VIP hoặc NON-VIP]\033[1;31;40m                 ║
║    [2] METHODS \033[1;32;40m[Xem Methods]\033[1;31;40m                                                  ║
║    [3] FILE UPDATE \033[1;32;40m[Bạn có thể xem các cập nhật mới trong Tệp của chúng tôi]  \033[1;31;40m║
╚════════════════════════════════════════════════════════════╝
    """)
	while 1:
...
def userinfo():
    ...
    print("""
╔════════════════════════════════════════════════════════════╗
║     USER TYPE: \033[1;32;40mVIP-USER         \033[1;31;40m                           ║
║     ADMIN    : \033[1;32;40mNgThanhVinh        \033[1;31;40m                         ║
║     ATTACK TIME: \033[1;32;40mUNLIMITED       \033[1;31;40m                          ║
║     USER EXPIRATION: \033[1;32;40mForever            \033[1;31;40m                   ║
...
╠═════════════════╬═══════════════════════╬══════════════════════╬═════════════════════╣
║  \033[1;36;40mATLAS-YOLANDA  \033[1;31;40m║ \033[1;36;40mBYPASS SOME FIREWALLS \033[1;31;40m║      \033[1;36;40mVIP-USER        \033[1;31;40m║      \033[2;30;42mAVAILABLE\033[1;31;40m      ║
╠═════════════════╬═══════════════════════╬══════════════════════╬═════════════════════╣
║   \033[1;36;40mATLAS-STORM   \033[1;31;40m║  \033[1;36;40mBYPASS NORMAL CLOUD  \033[1;31;40m║      \033[1;36;40mVIP-USER        \033[1;31;40m║      \033[2;30;42mAVAILABLE\033[1;31;40m      ║
╠═════════════════╬═══════════════════════╬══════════════════════╬═════════════════════╣
║   \033[1;36;40mATLAS-HTTPS   \033[1;31;40m║  \033[1;36;40mHTTPS-PROXY ATTACK   \033[1;31;40m║      \033[1;36;40mVIP-USER        \033[1;31;40m║      \033[2;30;42mAVAILABLE\033[1;31;40m      ║
╠═════════════════╬═══════════════════════╬══════════════════════╬═════════════════════╣
║   \033[1;36;40mATLAS-NULL    \033[1;31;40m║ \033[1;36;40mBYPASS OVH-DIGI SITES \033[1;31;40m║      \033[1;36;40mVIP-USER        \033[1;31;40m║      \033[2;30;42mAVAILABLE\033[1;31;40m      ║
╠═════════════════╬═══════════════════════╬══════════════════════╬═════════════════════╣
║   \033[1;36;40mATLAS-UAM     \033[1;31;40m║ \033[1;36;40mBYPASS CLOUDFLARE UAM \033[1;31;40m║      \033[1;36;40mVIP-USER        \033[1;31;40m║     \033[1;31;47mUNAVAILABLE\033[1;31;40m     ║
╚═════════════════╩═══════════════════════╩══════════════════════╩═════════════════════╝
    """)
...
def developer():
    ...
    print("""
╔════════════════════════════════════════════════════════════╗
║     DEVELOPER: Thành Vinh                                  ║
║     COMPILED SCRIPTS: Thành Vinh DEV                       ║        
╚════════════════════════════════════════════════════════════╝
    """)
    repeater()

def main():
	print("[+] Kiểm tra phụ thuộc...\n")
	pkgs = ['screen']
	install = True
	for pkg in pkgs:
		ok = which(pkg)
